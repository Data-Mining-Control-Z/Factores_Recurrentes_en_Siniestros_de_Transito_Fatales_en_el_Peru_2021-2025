...
Para ejecutar el código solo se necesita del archivo Entrega_1.ipynb. Ya que las bases de datos se leen directo de la fuente, no es necesario tener otros archivos descargados para la ejecución.


Fuentes de Datos
Las tres fuentes utilizadas fueron obtenidas del Observatorio Nacional de Seguridad Vial (ONSV). Los archivos corresponden a información preliminar del periodo 2021–2025:
  •	Siniestros de tránsito fatales 2021–2025 (preliminar).
  •	Vehículos involucrados en siniestros fatales 2021–2025 (preliminar).
  •	Personas involucradas en siniestros fatales 2021–2025 (preliminar).
